...
# Set before test modules import app code that may call Settings.from_env().
...
os.environ.setdefault("VKG_DEFAULT_CATALOG", "test_catalog")
os.environ.setdefault("VKG_DEFAULT_SCHEMA", "test_schema")
